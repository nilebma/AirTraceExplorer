...
internal class _MediaEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "length", "startDate", "title", "description", "color", "url");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "length", "startDate", "title", "description", "color", "url");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "length", "startDate", "title", "description", "color", "url");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "length", "startDate", "title", "description", "color", "url");
    ...
    public function _MediaEntityMetadata(value : _Super_Media)
    {
        ...
        model_internal::propertyTypeMap["color"] = "int";
