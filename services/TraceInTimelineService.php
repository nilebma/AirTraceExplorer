...
class TraceInTimelineService {
	 ...
	 * @return array
	 */
	public function getAllTraceInTimeline() {
	 ...
	 * @return stdClass
	 */
	public function getTraceInTimelineByID($itemID) {
	 ...
	 * @return void
	 */
	public function updateTraceInTimeline($item) {
	
		$stmt = mysqli_prepare($this->connection, "UPDATE $this->tablename SET idTimeline=?, idTrace=?, idSelector=?, position=?, delay=?, visible=? WHERE id=?");		
		$this->throwExceptionOnError();
		
		mysqli_stmt_bind_param($stmt, 'iiiiiii', $item->idTimeline, $item->idTrace, $item->idSelector, $item->position, $item->delay, $item->visible, $item->id);		
		$this->throwExceptionOnError();
	 ...
	 * @return void
	 */
	public function deleteTraceInTimeline($itemID) {
